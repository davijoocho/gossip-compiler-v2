...
enum token_type
{
    ...
    COMMA, LEFT_BRACE, RIGHT_BRACE, SEMI_COLON = 114, 
    ...
    // TYPES
    C8 = 100, I32 = 101, I64 = 102, F32 = 103, F64 = 104, STRING = 105, VOID = 200,

    // STATEMENTS
    FUNCTION = 106, STRUCT = 107, ASSIGN = 201,
    IF = 108, ELIF = 109, ELSE = 110, WHILE = 111, RETURN = 112,
